...
output_csv = os.path.join(base_dir, "../../Data/Clubs/transfermarkt_dynamic_leagues.csv")
...
league_map = {
    ...
    # ❌ "https://www.transfermarkt.com/premier-division/startseite/wettbewerb/IR1",
    # ❌ "https://www.transfermarkt.com/premier-division/startseite/wettbewerb/IRL1",

    "Cypriot First Division": "https://www.transfermarkt.com/1-division/startseite/wettbewerb/ZYP1",
    # ❌ "https://www.transfermarkt.com/1-division/startseite/wettbewerb/CY1",
    ...
    # ❌ "https://www.transfermarkt.com/veikkausliiga/startseite/wettbewerb/FIN1",
    ...
    # ❌ "https://www.transfermarkt.com/primera-division/startseite/wettbewerb/BOL1",
    # ❌ "https://www.transfermarkt.com/division-profesional/vereine/wettbewerb/BOL1",
    # ❌ "https://www.transfermarkt.us/division-profesional/startseite/wettbewerb/BOL1",

    "Primera División": "https://www.transfermarkt.com/torneo-apertura/startseite/wettbewerb/ARG1",
    # ❌ "https://www.transfermarkt.com/superliga/startseite/wettbewerb/AR1",
    # ❌ "https://www.transfermarkt.com/primera-division/startseite/wettbewerb/AR1",
    # ❌ "https://www.transfermarkt.us/liga-profesional/startseite/wettbewerb/AR1",
}

# === Fallback URLs ===
fallback_urls = {
    "Primeira Liga": [
        "https://www.transfermarkt.com/primeira-liga/startseite/wettbewerb/PO1",  # old
    ],
    "La Liga": [
        "https://www.transfermarkt.com/laliga/startseite/wettbewerb/ES1",  # alt slug
    ],
    "Cypriot First Division": [
        # "https://www.transfermarkt.com/1-division/startseite/wettbewerb/CY1",  # dead
    ],
    "Veikkausliiga": [
        # "https://www.transfermarkt.com/veikkausliiga/startseite/wettbewerb/FIN1",  # invalid
    ],
    ...
    "Primera División": [
        # ❌ legacy Argentina slugs
        # "https://www.transfermarkt.com/primera-division/startseite/wettbewerb/AR1",
        # "https://www.transfermarkt.com/superliga/startseite/wettbewerb/AR1",
        # "https://www.transfermarkt.us/primera-division/startseite/wettbewerb/AR1",
        "https://www.transfermarkt.fr/torneo-apertura/startseite/wettbewerb/ARG1", # this one works
    ],
    "Indian Super League": [
    ...
    "Greek Super League": [
        # sometimes localized domain variants or season pages work better
        "https://www.transfermarkt.fr/super-league/startseite/wettbewerb/GR1",
        # "https://www.transfermarkt.com/super-league/plus/wettbewerb/GR1?saison_id=2024",
    ],
    "Saudi Pro League": [
...
with sync_playwright() as p:
    ...
    for league in unique_leagues:
        ...
        for idx, url in enumerate(candidates):
            ...
            # adaptive timeout
            timeout_val = 90000 if league in ["EFL Championship", "Primeira Liga", "Major League Soccer",
                                              "Primera División", "Scottish Premiership"] else 60000
...
df_tm.to_csv(output_csv, index=False, encoding="utf-8-sig")
print(f"\n💾 Saved {len(df_tm)} clubs to {output_csv}")
